...
const airdropsCode = `export const airdrops = [
  {
    id: 'dow-protocol',
    name: 'Dow Protocol',
    ...
    funding: '$10.5M',
    investors: 'Animoca Brands, MH Ventures'
  },
  {
    id: 'ondo-perps',
    name: 'Ondo Perps',
...
fs.writeFileSync('src/data/airdrops.ts', airdropsCode, 'utf8');
...
`
fs.writeFileSync('build-db.cjs', i18nScript, 'utf8');
